...
// const numberArray = numbers.map(num => num ** 2);
...
//  { id: 3, values: [7, 8, 9] },
// ];
// const result = data.map(obj => obj.values).flat();
// console.log(result);
...
// const result = people.some(obj => obj.age < 20);
// console.log(result);
...
// const stringSorted = stringArray.toSorted();
...
//  { name: 'Bob', age: 19 },
// ];
// const userSorted = users.toSorted((a, b) => a.age - b.age)
